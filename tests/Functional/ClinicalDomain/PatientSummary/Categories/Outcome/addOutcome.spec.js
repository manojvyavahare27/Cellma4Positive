...
test.describe("Outcome Category", () => {
  test("Add Outcome", async ({ page }) => {
    ...
    for (const data of jsonData.PatientDetails) {
      ...
      await expect(page.getByText('Outcome deleted successfully')).toHaveText('Outcome deleted successfully')
      ...
      await outcome.selectandAddClinicalItem(jsonData.AddOutcome[index].pacr_que_name);
      ...
      await page.pause()
      await outcomeExtraDetails.clickOnSaveExtraDetails();
