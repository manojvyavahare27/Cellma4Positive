...
////////ADD NEW riskFactor/////
      ...
      await riskFactorExtraDetails.enterClinicalItemNotes(jsonData.AddRiskFactor[index].risk_notes);
    ...
    await riskFactor.toggleSearchSection(); //Close the search section
     ...
     // await riskFactorExtraDetails.clickOnClincialItemCollapsable();
      ...
      await riskFactorExtraDetails.enterClinicalItemNotes(jsonData.EditRiskFactor[index].risk_notes);
      await riskFactorExtraDetails.clickOnSaveExtraDetails();
      await page.waitForTimeout(1000);
