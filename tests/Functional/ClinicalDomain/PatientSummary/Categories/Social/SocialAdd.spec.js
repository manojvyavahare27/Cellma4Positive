...
////////ADD NEW social/////
     ...
     // await socialExtraDetails.clickOnClincialItemCollapsable();
      ...
      await socialExtraDetails.enterClinicalItemNotes(jsonData.Addsocial[index].soci_notes);
    ...
    await social.toggleSearchSection(); //Close the search section
      ...
      await socialExtraDetails.enterClinicalItemNotes(jsonData.Editsocial[index].soci_notes);
      await socialExtraDetails.clickOnSaveExtraDetails();
      await page.waitForTimeout(1000);
