...
test.describe("PatientScan Category", () => {
  test("Add PatientScan", async ({ page }) => {
   ...
   console.log("Patient Accessed by User:" + patId);
      ...
      await patientScanExtraDetails.enterClinicalItemNotes(jsonData.AddPatientScan[index].pascn_notes);
   ...
   // Toggle and edit existing Patient's Scan
      ...
      await page.waitForTimeout(1000);
      await patientScan.clickOnItemEdit('Doppler ultrasound');
      await page.waitForTimeout(2000);
      //await patientScanExtraDetails.clickOnClincialItemCollapsable();
      ...
      await patientScanExtraDetails.enterClinicalItemNotes(jsonData.EditPatientScan[index].pascn_notes);
      await patientScanExtraDetails.clickOnSaveExtraDetails();
      await page.waitForTimeout(1000);
